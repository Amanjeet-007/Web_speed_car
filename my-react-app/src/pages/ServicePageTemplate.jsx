          ...
          <div className="fixed bottom-6 left-1/2 transform -translate-x-1/2 z-50 bg-gray-900 text-white px-6 py-3.5 rounded-2xl shadow-2xl flex items-center gap-6 border border-gray-700">
            <div className="flex items-center gap-3">
              ...
              <p className="text-xs sm:text-sm font-medium">
                {popupMessage ||
                  `${cartItems[cartItems.length - 1]?.title} added to cart!`}
              </p>
            </div>
            <div className="flex items-center gap-3">
        ...
        <AnimatePresence>
          {cartItems.length > 0 && (
            <motion.div
              ...
              exit={{ opacity: 0, y: 50 }}
              className="fixed bottom-6 left-4 right-4 mx-auto max-w-md z-50 bg-gray-900 text-white px-5 py-3.5 rounded-2xl shadow-2xl flex items-center justify-between gap-4 border border-gray-700"
            >
              ...
              <div className="flex items-center gap-3 shrink-0">
                ...
                <button
                  onClick={() => navigate("/checkout")}
                  className="bg-blue-600 hover:bg-green-700 text-white text-xs font-bold px-3.5 py-2 rounded-xl transition cursor-pointer"
                >
                  Checkout
                </button>
              </div>
