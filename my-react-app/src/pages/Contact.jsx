      ...
      <div className="relative bg-gradient-to-r from-blue-900 via-blue-800 to-indigo-900 text-white py-16 px-4 overflow-hidden shadow-md">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <p className="text-blue-100/80 text-sm mt-2 max-w-xl">
            Have questions about our car care services or looking for a franchise opportunity? Reach out to us today.
          </p>
        </div>
      </div>
      ...
      <section className="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="bg-white p-8 sm:p-10 rounded-3xl shadow-sm border border-gray-100">
            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label htmlFor="fname" className="block text-xs font-bold text-gray-700 mb-1.5 uppercase tracking-wider">Your First Name *</label>
                  <input
                    type="text"
                    maxLength="100"
                ...
                <div>
                  <label htmlFor="lname" className="block text-xs font-bold text-gray-700 mb-1.5 uppercase tracking-wider">Your Last Name *</label>
                  <input
                    type="text"
                    maxLength="100"
                    className="w-full px-4 py-3 border border-gray-200 rounded-2xl focus:ring-2 focus:ring-blue-500 focus:outline-none bg-gray-50/50 text-sm transition"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label htmlFor="email" className="block text-xs font-bold text-gray-700 mb-1.5 uppercase tracking-wider">Your Email Address *</label>
                  <input
                    type="email"
                    maxLength="100"
                    className="w-full px-4 py-3 border border-gray-200 rounded-2xl focus:ring-2 focus:ring-blue-500 focus:outline-none bg-gray-50/50 text-sm transition"
                ...
                <div>
                  <label htmlFor="phone" className="block text-xs font-bold text-gray-700 mb-1.5 uppercase tracking-wider">Contact Number *</label>
                  <input
                    type="text"
                    maxLength="100"
                    className="w-full px-4 py-3 border border-gray-200 rounded-2xl focus:ring-2 focus:ring-blue-500 focus:outline-none bg-gray-50/50 text-sm transition"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label htmlFor="city" className="block text-xs font-bold text-gray-700 mb-1.5 uppercase tracking-wider">City *</label>
                  <input
                    type="text"
                    maxLength="100"
                    className="w-full px-4 py-3 border border-gray-200 rounded-2xl focus:ring-2 focus:ring-blue-500 focus:outline-none bg-gray-50/50 text-sm transition"
                ...
                <div>
                  <label htmlFor="state" className="block text-xs font-bold text-gray-700 mb-1.5 uppercase tracking-wider">State *</label>
                  <select
                    className="w-full px-4 py-3 border border-gray-200 rounded-2xl focus:ring-2 focus:ring-blue-500 focus:outline-none bg-gray-50/50 text-sm transition"
                    name="state"
                    id="state"
              ...
              {/* Message */}
              <div>
                <label htmlFor="message" className="block text-xs font-bold text-gray-700 mb-1.5 uppercase tracking-wider">Message *</label>
                <textarea
                  maxLength="5000"
                  rows="4"
              ...
              <div>
                <label className="block text-xs font-bold text-gray-700 mb-1.5 uppercase tracking-wider">Human Verification *</label>
                <div className="mt-1">
                  <ReCAPTCHA
          ...
          <div className="bg-white p-8 sm:p-10 rounded-3xl shadow-sm border border-gray-100 space-y-8">
            <div>
              <h3 className="text-xl font-black text-blue-900 tracking-tight">Get in <span className="text-blue-600">Touch</span></h3>
              <p className="text-xs text-gray-500 mt-1">We are always ready to help and answer any questions you might have.</p>
            </div>
              ...
              <div className="bg-blue-50/50 p-6 rounded-2xl border border-blue-50 space-y-4">
                ...
                <ul className="space-y-3.5 text-gray-600 text-xs leading-relaxed">
                  ...
                  <li className="flex items-center gap-3">
                    ...
                    <span><strong>Email:</strong> <a href="mailto:info@speedcarwash.com" className="text-blue-600 font-semibold hover:underline">info@speedcarwash.com</a></span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-blue-50/50 p-6 rounded-2xl border border-blue-50 space-y-4">
                ...
                <ul className="space-y-3.5 text-gray-600 text-xs leading-relaxed">
                  <li className="flex items-center gap-3">
                    ...
                    <span><strong>Franchise Contact:</strong> +91-9716412345</span>
                  </li>
                  <li className="flex items-center gap-3">
                    <div className="w-8 h-8 rounded-xl bg-blue-100 text-blue-600 flex items-center justify-center shrink-0">
                      <FaEnvelope />
                    </div>
                    <span><strong>Email:</strong> <a href="mailto:contact@speedcarwash.com" className="text-blue-600 font-semibold hover:underline">contact@speedcarwash.com</a></span>
                  </li>
                </ul>
              </div>
            </div>
        ...
        <div className="mt-12 rounded-3xl overflow-hidden shadow-lg border border-gray-100 group">
          <a href="https://www.speedcarwash.com/franchise/outlets" target="_blank" rel="noopener noreferrer">
            <img src="https://www.speedcarwash.com/images/explore.png" alt="Explore Networks" className="w-full object-cover group-hover:scale-105 transition duration-500" />
          </a>
        </div>
      </section>
